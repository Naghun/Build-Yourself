    ...
    <div className="container footer-starter">
        <div className='row footer-row d-flex justify-content-center align-items-center'>
            <div className="col-12 footer-container d-flex justify-content-center align-items-center">
                ...
                <div className="design-container col-5 d-flex flex-column justify-content-start align-items-center">
                    <h3 className="design col-12 d-flex justify-content-start align-items-center text-center p-0 m-0">Designed by: <span>Naghun</span></h3>
                    <h3 className="rights col-12 d-flex justify-content-start align-items-center text-center p-0 m-0">All rights reserved <span>- 2024</span></h3>
                </div>
                <ul className="col-4 d-flex justify-content-center align-items-center footer-list">
                ...
                <div className="col-2 d-flex justify-content-end align-items-center footer-icons">
